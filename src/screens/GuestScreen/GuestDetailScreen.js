...
const TextInputWrap2 = ({ children }) =>
  <View style={[styles.textInputWrap, { width: StyleConfig.width * 0.5 - StyleConfig.countPixelRatio(32), margin: StyleConfig.countPixelRatio(8) }]}>
    {children}
  </View>
class GuestDetailScreen extends Component {
  ...
  render() {
    const { name, allContacts, contactListVisible, groupName, adult, children } = this.state
    return (
      <>
        ...
        <SafeAreaView style={styles.flex1White}>
          <View style={styles.headerWrap}>
            ...
            <TouchableOpacity onPress={() => alert("Submit button pressed")}>
              <View
                style={styles.backWrap}>
              ...
              <View style={styles.row}>
                <TextInputWrap2>
                  <TextInput
                    ...
                    returnKeyType='done'
                    onChangeText={(text) => this.setState({ adult: text })}
                    placeholderTextColor={StyleConfig.COLORS.hintTextColor}
                    placeholder={'Adult'}
                  />
                </TextInputWrap2>
                <TextInputWrap2>
                  <TextInput
                    ...
                    keyboardType={'phone-pad'}
                    returnKeyType='done'
                    onChangeText={(text) => this.setState({ children: text })}
                    placeholderTextColor={StyleConfig.COLORS.hintTextColor}
